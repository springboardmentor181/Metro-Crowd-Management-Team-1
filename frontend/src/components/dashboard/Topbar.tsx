...
type ApiAlert = { id: string; type: 'overcrowding' | 'delay' | 'emergency'; severity: string; status: string; station: string; message: string; ago: string };
const getAlerts = async () => ({ alerts: [] as ApiAlert[] });
const NETWORKS = ["Blue Line", "Yellow Line", "Red Line"];
